            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">                        
                        ...
                        <a class="btn btn-sm btn-outline-secondary float-right" href="{{route('seller-product.create')}}"><b>+create Product</b></a></h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('seller')}}"><i class="icon-home"></i></a></li>                            
                            
                            <li class="breadcrumb-item active">Product</li>
                        </ul>
                        <p><h3>Total Products: {{$products->count()}}</h3></p>
                    </div>            
                </div>
            </div>
                                ...
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('seller-product.show',$item->id)}}" data-toggle="tooltip" title="add attribute" class="btn btn-sm btn-outline-secondary"><i class="icon-plus"></i></a>
                                                ...
                                                <a href="{{route('seller-product.edit',$item->id)}}" data-toggle="tooltip" title="edit" class="btn btn-sm btn-outline-primary"><i class="icon-note"></i></a>
                                                <button type="button" onclick="deleteProduct({{$item->id}})"  class="btn btn-sm btn-outline-danger"><i class="icon-trash"></i></button>
                                                <form id="delete-form-{{ $item->id}}" action="{{route('seller-product.destroy',$item->id)}}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('delete')
                                                </form>
