                ...
                <div class="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                    <div class="single_footer_area mb-100">
                        ...
                        <div class="footer_social_area mt-15">
                            ...
                            <a href="{{\App\Models\Setting::value('painterest_url')}}"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="copywrite_text">
                            <p>Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/" target="_blank">{{\App\Models\Setting::value('footer')}}</a></p>
                        </div>
                    </div>
                    <!-- Payment Method -->
                    <div class="col-12 col-md-6">
